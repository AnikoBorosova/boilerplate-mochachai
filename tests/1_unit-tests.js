...
suite('Unit Tests', function () {
  ...
  suite('Comparisons', function () {
    // #8
    test('#isAbove, #isAtMost', function () {  // isAtMost -- less than or equal to 
    ...
    // #10
    test('#approximately', function () {   // Asserts that the 'actual' is equal to 'expected', to within a +/- delta range.
      assert.approximately(weirdNumbers(0.5), 1, 0.5);  // assert.approximately(1.5, 1, 0.5, 'numbers are close');
